...
logger = logging.getLogger("craftforge")


@asynccontextmanager
async def lifespan(app: FastAPI):
    logger.info("CraftForge starting")
    yield
    logger.info("CraftForge shutting down")


app = FastAPI(
    title="CraftForge",
    description="Web GUI for creating and hosting Minecraft dedicated servers",
    version="1.0.0",
    lifespan=lifespan,
)
